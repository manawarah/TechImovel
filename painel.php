...
<body>
  ...
  <div class="sidebar d-flex flex-column">
    ...
    <nav class="nav flex-column px-3">
      <a class="nav-link active" href="painel.php"><i class="bi bi-speedometer2"></i> Dashboard</a>
  ...
  <div class="main-content">
    ...
    <p>Aqui você pode gerenciar seus clientes, imóveis e mais.</p>
...
<div >
    ...
    <p>Você está logado no sistema TechImóvel.</p>

    <?php include_once('./includes/painel_usuario.php'); ?>
